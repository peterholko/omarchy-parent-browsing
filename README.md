...
This repository contains the user interface. Version 0.1.0 requires the separately installed `omarchy-parent-addons-browsing` and `omarchy-parent-addons-core` packages from [backend release v0.1.0](https://github.com/peterholko/omarchy-parent-addons/releases/tag/v0.1.0). The backend does not depend on the Omarchy Kids distribution or replace Omarchy. Linux installation and authentication checks are still pending; see the [validation record](https://github.com/peterholko/omarchy-parent-addons/blob/v0.1.0/VALIDATION.md).
